...
| `scene.request` | control | `textures: none\|opacity\|full, tex_max, influences: 4\|8` | Phase 1 |
| `asset.request` | bulk | `hashes: [...]` | Phase 1 |
...
| `progress` | control | `op, done, total, label` | Phase 1 |
| `scene.manifest` | control | see design doc | Phase 1 |
| `asset.data` | bulk | `hash, kind, size` + payload | Phase 1 |
